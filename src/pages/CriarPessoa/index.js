    ...
    <C.BackButton onClick={handleBack}>
      ...
      Voltar
        ...
        <C.FormContainer onSubmit={handleSubmit}>
          ...
          <C.Section>
            <C.SectionTitle type="button"onClick={(e) => {  e.stopPropagation();toggleSection("pessoais")}}>
              Dados pessoais
            </C.SectionTitle>
          ...
          <C.Section>
            <C.SectionTitle type="button" onClick={(e) => {  e.stopPropagation();toggleSection("contato")}}>
              Contato
            </C.SectionTitle>
          ...
          <C.Section>
            ...
            {/* Treinamentos */}
            <C.SectionTitle type="button"onClick={(e) => {  e.stopPropagation();toggleSection("documentos")}}>
          ...
          <C.Section>
            {/* Treinamentos */}
            <C.SectionTitle type="button"onClick={(e) => {  e.stopPropagation(); toggleSection("treinamentos")}}>
              Treinamentos
            </C.SectionTitle>
          ...
          <C.Section>
            {/* Documentos */}
            <C.SectionTitle type="button"onClick={(e) => {  e.stopPropagation(); toggleSection("responsaveis")}}>
              Responsáveis
            </C.SectionTitle>
          ...
          <C.SubmitButton type="submit">Salvar</C.SubmitButton>
